...
public class MyQueue <E>{
	...
	public void enqueue(E data) {  //Ingresamos un elemento a la cola
	...
	public E dequeue() throws NoSuchElementException{  //Eliminamos un elemento de la cola
		try {
			//Se elimina el primer elemento de la cola (que fue el primer ingresado)
			return this.list.removeFirst();
		} catch (NoSuchElementException e) { //Traducimos la excepcion que pueda lanzar el metodo utilizado
			throw new NoSuchElementException("It's not possible to do a dequeue in an empty list.");
		}
		
	}
	
	public E peek() throws NoSuchElementException{ //Visualizamos el primer elemento de la cola (el primer dato ingresado, bottom)
		try {
	...
	public void flush() {
		this.list = new myLinkedList<>(); // Creamos una nueva lista enlazada de manera que este vacia
